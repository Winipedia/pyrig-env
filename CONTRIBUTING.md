...
Thanks for considering a contribution to pyrig-env! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-env/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-env/actions/workflows/health_check.yml) must pass before merge.
